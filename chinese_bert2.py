...
if __name__ == '__main__':
    ...
    c8, all8 =get_probability(amb_f1, f'result/{args.model}/amb_f1.tsv', antecedent='f', possible_antecedent=['f','m'])
    c9, all9 =get_probability(amb_m1, f'result/{args.model}/amb_m1.tsv', antecedent='m', possible_antecedent=['f','m'])
